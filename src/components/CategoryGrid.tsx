...
const CategoryCard = ({
  ...
  return (
    <a href={link}
      ...
      ref={ref} 
      className={cn("category-card group", isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10")} 
      style={{
    ...
    <section className="py-16 px-4" ref={ref}>
      <div className="container mx-auto">
        <div className={cn(
          ...
          <span className="inline-block bg-mytroc-primary/10 text-mytroc-primary px-4 py-1 rounded-full text-sm font-medium mb-4">Nos catégories</span>
          <h2 className="text-3xl font-bold mb-4">Explorez notre sélection</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Découvrez une large gamme de produits de qualité dans nos différentes catégories
          </p>
        </div>
