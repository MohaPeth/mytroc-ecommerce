          ...
          return <React.Fragment key={step.id}>
              ...
              <div className="relative flex flex-col items-center">
                <Link to={step.path} className="cursor-pointer">
                  <div className={`rounded-full h-12 w-12 flex items-center justify-center border-2 transition-colors ${
              ...
              {/* Connector line */}
              {index < steps.length - 1 && <div className={`hidden md:block flex-1 h-0.5 mx-2 ${
